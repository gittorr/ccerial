...
public class VariablePojoTest {
    ...
    private static final String ENCODED_DATA = "Rf/jsgAAAAAIUm9iaW5zb24GQ3J1c29lG82Zs+bMicbSQAVIT1VTRQ==";

    @Test
    public void testVariablePojo() throws IOException {
        Serializer<Client> serializer = Ccerial.getSerializer(Client.class);
        Client client = new Client(ROBINSON, CRUSOE, AGE, BALANCE, HouseType.HOUSE);
